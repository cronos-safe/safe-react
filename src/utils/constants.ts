...
export const DEFAULT_CHAIN_ID =
  process.env.REACT_APP_DEFAULT_CHAIN_ID || (IS_PRODUCTION ? CHAIN_ID.CRONOS_MAINNET : CHAIN_ID.CRONOS_TESTNET)
export const PUBLIC_URL = process.env.PUBLIC_URL
export const TX_SERVICE_VERSION = '1'
export const INTERCOM_ID = IS_PRODUCTION ? process.env.REACT_APP_INTERCOM_ID ?? '' : ''
export const BEAMER_ID = IS_PRODUCTION && process.env.REACT_APP_BEAMER_ID ? process.env.REACT_APP_BEAMER_ID : ''
...
export const ETHERSCAN_API_KEY = process.env.REACT_APP_ETHERSCAN_API_KEY ?? null
...
export const LS_NAMESPACE = 'CRONOS_SAFE'
